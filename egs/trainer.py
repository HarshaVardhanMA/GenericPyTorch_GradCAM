...
def fit(train_loader,
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        train_epoch_acc, train_epoch_losses = train_epoch(model,
                                                          ...
                                                          l1_reg,
                                                          l1_lambda=l1_lambda)
        writer.add_scalar('Batch averaged train loss at nth epoch', mean(train_epoch_losses), epoch+1)
        writer.add_scalar('Batch averaged train accuracy at nth epoch', mean(train_epoch_acc), epoch+1)
        ...
        if epoch == n_epochs-1:
            ...
            test_acc_epoch, test_losses_epoch = test_epoch(model,
                                                           ...
                                                           test_loader,
                                                           criterion)
        writer.add_scalar('Batch averaged test loss after n epochs of training', test_losses_epoch, epoch+1)
        writer.add_scalar('Batch averaged test accuracy after n epochs of training', test_acc_epoch, epoch+1)
        ...
        if scheduler is not None:
            ...
            writer.add_scalar("Learning rate across epochs", optimizer.param_groups[0]['lr'], epoch+1)
...
def test_epoch(model, 
    ...
    print("Here {}".format(test_loss / len(test_loader)) )
